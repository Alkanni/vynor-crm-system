    ...
    <div className="flex flex-col gap-6 p-6 max-w-7xl mx-auto w-full select-none">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-card border border-border p-4 rounded-lg shadow-2xs">
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5">31.8% safely escalated to human</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-card border border-border rounded-lg overflow-hidden shadow-2xs">
          <div className="p-4 bg-surface border-b border-border flex items-center justify-between">
            ...
            <span className="text-[11px] text-muted-foreground font-mono">Shift 1 (08:00 - 16:00)</span>
          </div>
              ...
              <div key={i} className="flex items-center justify-between py-2 px-1">
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    <span className="font-mono font-semibold text-foreground">{agent.openConvs}</span>
        ...
        <div className="bg-card border border-border rounded-lg overflow-hidden shadow-2xs">
          ...
          <div className="divide-y divide-border p-3 text-xs space-y-1">
            {[
              { channel: 'WhatsApp Cloud API Official', status: 'OPERATIONAL', latency: '38ms', throughput: '7,622 msgs/24h' },
              { channel: 'Telegram Support Bot', status: 'OPERATIONAL', latency: '24ms', throughput: '2,385 msgs/24h' },
              { channel: 'Enterprise Email Ingress', status: 'OPERATIONAL', latency: '95ms', throughput: '795 msgs/24h' },
              { channel: 'Live Webchat Widget', status: 'OPERATIONAL', latency: '18ms', throughput: '1,255 msgs/24h' },
            ].map((ch, i) => (
              <div key={i} className="flex items-center justify-between py-2 px-1">
                <div>
